 ...
 */
public class FHlinkedList<E> implements Cloneable, Iterable<E>, Collection<E>, Queue<E>, Deque<E>, List<E>
{
	/**
	...
	/**
	 * Reversing a list is not supported
	 *
	 * @return null
	 */
	@Override
	public FHlinkedList<E> reversed() {
		return null;
	}
